...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--crawler',
                        help="the crawler identifier; you can have multiple crawler accounts set in the apikeys.json; pick one",
                        required=True)
    ...
    with open(os.path.abspath(args.apikeys), 'rb') as apikeys_f, open(os.path.abspath(args.keywords),
                                                                      'rb') as keywords_f:
        import json, os
