...
from utils import get_keys_by_min_value
...
class NodeQueue(RedisQueue):
    ...
    def clear_all_queues(self):
        # This will not only clear the node queue (mostly for control cmds);
        # but also the crawlers' cmd queues to give you a fresh start
